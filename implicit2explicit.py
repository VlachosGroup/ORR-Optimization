...
plt.plot(GCNvals,EOHexpl-EOHGCNimpl,'bo',GCNvals,EOOHexpl-EOOHGCNimpl,'go')
plt.plot(GCNvals,EOHGCNimpl*EOHimpl2explslope + EOHimpl2explint,'b-',GCNvals,EOOHGCNimpl*EOOHimpl2explslope + EOOHimpl2explint,'g-')
plt.ylabel('(Explicit-Implicit) Solvation [eV]')
plt.xlabel('GCN')
plt.legend(['OH*','OOH*'],frameon=False)
...
plt.plot(Coverage,EOHexpl5_167,'ro',Coverage,EOHexpl7_5,'bo',Coverage,EOHexpl8_5,'go',Coverage,EOHexpl7_5O,'co')
plt.plot(Coverage,EOHexpl5_167[0]+Coverage*OH5_167slope,'r-',Coverage,EOHexpl7_5[0]+Coverage*OH7_5slope,'b-',Coverage,EOHexpl8_5[0]+Coverage*OH8_5slope,'g-',Coverage,EOHexpl7_5O[0]+Coverage*OH7_5Oslope,'c-')
plt.xlabel('OH Coverage (ML)')
plt.ylabel('OH Adsorption Energy (eV)')
plt.legend(['Edge (5.167 GCN)','Pt111 (7.5 GCN)','Cavity (8.5 GCN)','Pt111+O (7.5 GCN)'],frameon=False)

plt.figure(2,figsize=(8,5))
plt.plot(Coverage,EOOHexpl5_167,'ro',Coverage,EOOHexpl7_5,'bo',Coverage,EOOHexpl8_5,'go',Coverage,EOOHexpl7_5O,'co')
plt.plot(Coverage,EOOHexpl5_167[0]+Coverage*OOH5_167slope,'r-',Coverage,EOOHexpl7_5[0]+Coverage*OOH7_5slope,'b-',Coverage,EOOHexpl8_5[0]+Coverage*OOH8_5slope,'g-',Coverage,EOOHexpl7_5O[0]+Coverage*OOH7_5Oslope,'c-')
plt.xlabel('OH Coverage (ML)')
plt.ylabel('OOH Adsorption Energy (eV)')
plt.legend(['Edge (5.167 GCN)','Pt111 (7.5 GCN)','Cavity (8.5 GCN)','Pt111+O (7.5 GCN)'],frameon=False)